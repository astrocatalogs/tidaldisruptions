...
for fcnt, eventfile in enumerate(tq(sorted(files, key=lambda s: s.lower()))):
    ...
    if dohtml and args.writehtml:
        ...
        html = re.sub(r'(\<\/title\>)', r'''\1\n
            <base target="_parent" />\n
            <link rel="stylesheet" href="https://tde.space/astrocats/astrocats/tidaldisruptions/html/event.css" type="text/css">\n
            <script type="text/javascript" src="https://tde.space/astrocats/astrocats/tidaldisruptions/scripts/marks.js" type="text/css"></script>\n
